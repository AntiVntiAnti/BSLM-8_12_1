...
class MainWindow(FramelessWindow, QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self,
        ...
        # Assuming you're initializing your table views here
    ...
    def setup_formatting_actions(self) -> None:
        """
        Connects formatting operations to respective actions.
        ...
        try:
            ...
            self.action_highlight.triggered.connect(
                lambda:
                self.text_formatter_highlight.apply_current_text_format(
                    self.text_formatter_highlight.format_text
                )
            )
            self.action_color.triggered.connect(
                lambda:
                self.text_formatter_color.apply_current_text_format(
            ...
            self.action_increase_font_size.triggered.connect(
                lambda:
                self.text_formatter_increase_font.apply_current_text_format(
                    self.text_formatter_increase_font.increase_font_size
                )
            )
            self.action_decrease_font_size.triggered.connect(
                lambda:
                self.text_formatter_decrease_font_size.apply_current_text_format(
